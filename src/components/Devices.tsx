...
export default function Devices() {
  const devices = [
    { icon: Cpu, label: "PC", specs: "Ryzen 9 5950x, 3090ti, 32GB DDR4" },
    { icon: Smartphone, label: "Phone", specs: "Samsung S24 Ultra SnapDragon" },
    { icon: Laptop, label: "Laptop", specs: "Thinkpad T480 (Arch Linux)" },
    { icon: Monitor, label: "Monitor", specs: "MSI G274QPXDE 240hz 1440p" }
  ];
